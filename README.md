#TCPCopy - A Powerful TCP Stream Replay Tool
...
1. Recommended advanced use
  - ./configure --enable-advanced --enable-pcap  
2. mysql replay with mysql in test server working in skip-grant-table mode
...
+ 2013.06  version 0.8.0, support new configure option with configure --enable-advanced for advanced users and optimize intercept
